...
$("#movies").on("click", ".collapsible-header", function(){
  ...
  $.ajax({
    ...
    var youtubeVid = $("<iframe class='dynamic-iframe' width='640' height='360' src='https://www.youtube.com/embed/" + response.items[0].id.videoId + "?enablejsapi=1' frameborder='0' style='border: solid 4px #37474F'></iframe>");
